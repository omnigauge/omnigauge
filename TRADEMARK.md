...
- Name your fork OmniGauge, or a name close enough to be mistaken for it
- Use the logo, or a variation of it, to identify your project
- Register a domain or social account that reads as an official OmniGauge one
- Describe your fork as "official", "the new OmniGauge", or endorsed by anyone here
...
- "a fork of OmniGauge"
- "based on OmniGauge"
- "compatible with OmniGauge providers"
- "OmniGauge is a similar tool"
...
If you want to use the name for something, ask: **dev@omnigauge.dev**. The answer
is often yes.
